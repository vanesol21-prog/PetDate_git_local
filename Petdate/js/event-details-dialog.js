...
function fillEventDetailsDialog(parent, event) {
  ...
  const eventDetailsDocumentElement = eventDetailsElement.querySelector("[data-event-details-document]");
  const eventDetailsPetNameElement = eventDetailsElement.querySelector("[data-event-details-pet-name]");
  ...
  eventDetailsDocumentElement.textContent = event.document;
  eventDetailsPetNameElement.textContent = event.petName;
